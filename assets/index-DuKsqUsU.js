(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const e of n.addedNodes)e.tagName==="LINK"&&e.rel==="modulepreload"&&a(e)}).observe(document,{childList:!0,subtree:!0});function o(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(s){if(s.ep)return;s.ep=!0;const n=o(s);fetch(s.href,n)}})();function S(){return S=Object.assign?Object.assign.bind():function(i){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var a in o)({}).hasOwnProperty.call(o,a)&&(i[a]=o[a])}return i},S.apply(null,arguments)}function j(i){const t=new Uint8Array(i);return window.btoa(String.fromCharCode(...t))}function $(i){const t=window.atob(i),o=t.length,a=new Uint8Array(o);for(let s=0;s<o;s++)a[s]=t.charCodeAt(s);return a.buffer}const z=new Blob([`
  ...
  `],{type:"application/javascript"}),G=URL.createObjectURL(z);function W(){return["iPad Simulator","iPhone Simulator","iPod Simulator","iPad","iPhone","iPod"].includes(navigator.platform)||navigator.userAgent.includes("Mac")&&"ontouchend"in document}class E{static async create({sampleRate:t,format:o,preferHeadphonesForIosDevices:a}){let s=null,n=null;try{const l={sampleRate:{ideal:t},echoCancellation:{ideal:!0},noiseSuppression:{ideal:!0}};if(W()&&a){const _=(await window.navigator.mediaDevices.enumerateDevices()).find(C=>C.kind==="audioinput"&&["airpod","headphone","earphone"].find(f=>C.label.toLowerCase().includes(f)));_&&(l.deviceId={ideal:_.deviceId})}const h=navigator.mediaDevices.getSupportedConstraints().sampleRate;s=new window.AudioContext(h?{sampleRate:t}:{});const g=s.createAnalyser();h||await s.audioWorklet.addModule("https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js"),await s.audioWorklet.addModule(G),n=await navigator.mediaDevices.getUserMedia({audio:l});const w=s.createMediaStreamSource(n),v=new AudioWorkletNode(s,"raw-audio-processor");return v.port.postMessage({type:"setFormat",format:o,sampleRate:t}),w.connect(g),g.connect(v),await s.resume(),new E(s,g,v,n)}catch(l){var e,r;throw(e=n)==null||e.getTracks().forEach(h=>h.stop()),(r=s)==null||r.close(),l}}constructor(t,o,a,s){this.context=void 0,this.analyser=void 0,this.worklet=void 0,this.inputStream=void 0,this.context=t,this.analyser=o,this.worklet=a,this.inputStream=s}async close(){this.inputStream.getTracks().forEach(t=>t.stop()),await this.context.close()}setMuted(t){this.worklet.port.postMessage({type:"setMuted",isMuted:t})}}const H=new Blob([`
